...
( function( $) {
    $.wpMediaUploader = function( options ) {
        ...
        var settings = $.extend({
            ...
            uploaderTitle : 'Select or upload', // The title of the media upload popup
            uploaderButton : 'Use file', // the text of the button in the media upload popup
        ...
        $( settings.target ).append( '<a href="#" class="' + settings.buttonClass.replace('.','') + ' btn btn-info">' + settings.buttonText + '</a>' );
